# Modpack v0.2.1 — Dedicated Server Instructions
...
This is modpack v0.2.1 — see CHANGELOG.md for what changed. Server-side mods should match the version installed on clients; mismatched BepInEx/mod versions between server and clients can cause connection or desync issues.
